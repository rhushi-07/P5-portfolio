...
import astroid from "./assets/nasa3.jpeg";
import mainm2 from "./assets/AI.jpeg";
import mainf from "./assets/mainf.jpeg";

const CHARS = [char1, char2, char3, char4];
const MAIN_IMAGES = [mainf, astroid, mainm2, run];

const REVEAL_CONTENT = [
  {
    upper: [
      "KYŪEN (2D Action Roguelike)",
      "Engine: Unity | Language: C#",
      "Features: State AI, elemental spells, and adaptive maps"
    ],
    lower: "developed a fast-paced rogue-action game with complex projectile combat and custom parallax stages.",
  },
  {
    upper: [
      "Hybrid Asteroid Path Prediction",
      "Stack: Python, Pandas, NumPy, Scikit-Learn",
      "Features: Trajectory simulation & ensemble risk estimation"
    ],
    lower: "applied for a patent on a machine learning orbital prediction model integrating trajectory uncertainty.",
  },
  {
    upper: [
      "Offline AI Teacher Assistant",
      "Framework: Django | Models: Local LLMs",
      "Features: Voice communication & explanation image cards"
    ],
    lower: "designed to support students in rural or low-connectivity zones, winning accolades at techathon 2024.",
  },
  {
    upper: [
      "Balloon Runner & AR Apps",
      "Framework: Unity AR Foundation | C#",
      "Features: Custom health subsystems & AI support tutors"
    ],
    lower: "built dynamic interactive gameplay zones and personalized Spatial learning mechanics as an intern at LSOYS.",
  },
];
...
const ITEMS = [
  {
    id: "kyuen", label: "KYŪEN ROGUELIKE", handle: "@rhushikesh", href: "https://github.com/rhushi-07", icon: "🕹️", barIcon: icon1, bars: 1, newBars: [0], counts: ["UNITY"],
  ...
  {
    id: "asteroid", label: "ASTEROID PREDICTION", handle: "@rhushikesh", href: "https://github.com/rhushi-07", icon: "☄️", barIcon: icon2, bars: 1, newBars: [0], counts: ["PYTHON"],
    links: ["github.com/rhushi-07"],
    stats: [
  ...
  {
    id: "aiteacher", label: "AI OFFLINE TEACHER", handle: "@rhushikesh", href: "https://github.com/rhushi-07", icon: "🤖", barIcon: icon3, bars: 1, newBars: [0], counts: ["DJANGO"],
    links: ["github.com/rhushi-07"],
    stats: [
      { tag: "FRM", value: "Django", color: "#092e20" },
      { tag: "LAN", value: "Python", color: "#3572A5" },
    ],
  },
  {
    id: "balloon", label: "BALLOON RUNNER AR", handle: "@rhushikesh", href: "https://github.com/rhushi-07", icon: "🎈", barIcon: icon1, bars: 1, newBars: [0], counts: ["UNITY AR"],
    links: ["github.com/rhushi-07"],
    stats: [
      { tag: "ENG", value: "Unity", color: "#ffffff" },
      { tag: "WRK", value: "LSOYS", color: "#4a8fff" },
    ],
  },
];
    ...
    <div id="menu-screen">
      ...
      <style>{`
        ...
        .sc-root {
          ...
          align-items: flex-end; /* Mirrored layout: elements stack on right! */
          justify-content: center;
          gap: 6px;
          padding-right: 0;
        }
        ...
        @keyframes sc-reveal-bar-in {
          0% {
            opacity: 0;
            transform: translateX(120px) rotate(20deg) scaleX(0.72); /* Mirrored skew animation! */
          }
          60% {
            opacity: 0.96;
        ...
        @keyframes sc-portrait-in {
          0% {
            opacity: 0;
            transform: translateX(-78px) skewX(8deg) scale(0.94); /* Mirrored entry skew! */
            filter: blur(8px);
          }
          55% {
            opacity: 0.9;
        ...
        .sc-reveal-panel {
          ...
          clip-path: polygon(0 0, 100% 0, 100% 100%, 88px 100%); /* Mirrored shape */
          box-shadow:
            0 0 0 2px rgba(255,255,255,0.18),
            -18px 0 0 rgba(215, 13, 44, 0.82), /* Mirrored drop strip */
            -28px 0 0 rgba(255,255,255,0.26);
          opacity: 0;
          transform: translateX(40px) rotate(20deg); /* Mirrored rotate skew! */
        ...
        .sc-close-btn {
          position: absolute;
          bottom: 16px;
          left: 120px; /* Mirrored positioning to sit nicely at the bottom-left edge */
          background: #c4001a;
          color: #fff;
          border: none;
          font-family: 'Bebas Neue', sans-serif;
        ...
        .sc-reveal-upper-bar {
          position: absolute;
          top: 10%;
          right: 32%; /* Mirrored layout: Anchored on the right, bleeds leftward! */
          width: 78%;
          height: 40%;
          background: rgba(0, 0, 0, 0.92);
          clip-path: polygon(22px 0, 100% 0, 100% 100%, 0 100%); /* Mirrored skew left edge */
          ...
          color: #fff;
          text-align: center;
          padding: 0 20px 0 40%; /* Pad the left side to confine text rightward! */
        }
        ...
        .sc-reveal-lower-bar {
          ...
          white-space: normal;
          overflow-y: auto;
          padding: 10px 24px 10px 40%; /* Pad left side */
        }
        ...
        .sc-right-nav {
          position: absolute;
          top: 10vh;
          right: 6vw; /* Mirrored layout: aligned top-right! */
          display: flex;
          align-items: center;
          gap: 6px;
          pointer-events: none;
          z-index: 14;
          transform: translateX(40px) rotate(20deg); /* Mirrored transform! */
          transform-origin: right bottom;
        ...
        .sc-main-portrait {
          ...
          transform: skewX(-8deg) scale(1.08); /* Mirrored skew! */
        ...
        .sc-bar {
          ...
          cursor: pointer;
          pointer-events: all;
          clip-path: polygon(0 0, 100% 0, 100% 100%, 14px 100%); /* Mirrored shape skew bottom-left edge */
        ...
        .sc-bar-outer {
          position: relative;
          flex-shrink: 0;
          transform: translateX(100%); /* Mirrored slide in direction! */
        ...
        .sc-bar-red {
          ...
          height: 64px;
          background: #c4001a;
          clip-path: polygon(0 0, 50% 0, calc(50% + 10px) 100%, 10px 100%); /* Mirrored red skew */
        ...
        /* white fill — skewed parallelogram */
        .sc-bar-fill {
          position: absolute;
          inset: 0;
          width: 100%;
          background: #ffffff;
          clip-path: polygon(0 0, 0 0, 32px 100%, 32px 100%); /* Mirrored fill start */
          transition: clip-path 0.35s cubic-bezier(0.22, 1, 0.36, 1);
          z-index: 0;
        }
        .sc-bar-outer.active .sc-bar-fill {
          clip-path: polygon(0 0, 78% 0, calc(78% - 14px) 100%, 0 100%); /* Mirrored active fill */
        }
        ...
        .sc-role {
          ...
          letter-spacing: -2px;
          color: #ffffff;
          transform: rotate(30deg); /* Mirrored rotation! */
          user-select: none;
          line-height: 1;
          padding: 0 16px 0 8px;
        }

        /* icon + name centered in remaining space */
        .sc-main {
          flex: 1;
          display: flex;
          flex-direction: column;
          ...
          justify-content: center;
          gap: 3px;
          padding-right: 200px; /* Mirrored layout: Pushed leftwards, safe from thumbnail! */
          padding-left: 20px;
        }
        .sc-main-top {
          display: flex;
        ...
        /* character portrait inside bar */
        .sc-char {
          position: absolute;
          top: 0;
          right: 30px; /* Mirrored layout: shifted further to the right to bleed off the edge! */
          height: 100%;
          width: auto;
          max-width: 160px;
          object-fit: cover;
          ...
          pointer-events: none;
          z-index: 3;
          clip-path: polygon(0% 0%, calc(100% - 20px) 0%, 100% 100%, 20px 100%); /* Mirrored skew */
        }

        /* footer hints */
        .sc-footer {
          position: fixed;
          bottom: 20px; left: 28px; /* Mirrored: on the left side! */
      ...
      <div className="sc-mobile-controls" aria-label="Projects mobile controls">
