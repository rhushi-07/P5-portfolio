    ...
    <div id="menu-screen">
      ...
      <style>{`
        ...
        .sc-char {
          position: absolute;
          top: 0;
          right: -20px; /* Mirrored layout: shifted further to the right to bleed off the edge! */
          height: 100%;
          width: auto;
          max-width: 160px;
          object-fit: cover;
